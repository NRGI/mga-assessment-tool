...
angular.module('app').controller('nrgiDeskResearchListCtrl', function ($scope, $route, $routeParams, $location, nrgiIdentitySrvc, nrgiNotifier, nrgiAssessmentSrvc, nrgiAssessmentMethodSrvc, nrgiUserListSrvc, nrgiAnswerSrvc) {
    //filtering options
    $scope.sort_options = [
