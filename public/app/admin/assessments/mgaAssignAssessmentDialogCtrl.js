...
angular.module('app').controller('mgaAssignAssessmentDialogCtrl', function ($scope, $location, mgaNotifier, mgaAssessmentSrvc, mgaAssessmentMethodSrvc, mgaUserSrvc, mgaUserMethodSrvc) {
